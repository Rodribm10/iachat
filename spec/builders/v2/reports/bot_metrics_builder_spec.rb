  ...
  describe '#metrics' do
    context 'with valid params' do
      ...
      it 'returns correct metrics' do
        ...
        # No fork, handoff_rate = handoff automatico + takeover manual. A mensagem
        # outgoing sem sender (como as que chegam por echo do WhatsApp) conta como
        # takeover, entao as duas conversas entram: 100%, e nao os 50% do upstream.
